...
function Profile() {
  ...
  return (
 <div className='flex flex-col gap-5 justify-center items-center p-10 m-5'>

    <div
    class=" w-full flex items-center justify-between rounded-[1.5em] gap-20 bg-[#FFF599] p-[2rem]"
  >

    <p class="text-[1.25rem] font-bold text-blue-950">Manpreet Singh</p>
    <svg
      viewBox="0 0 48 48"
      fill="none"
      height="48"
...
<div
  class="fitCard flex w-full flex-col items-center justify-center gap-[0.5rem] rounded-[1.5em] bg-[#FFFACD]  p-[0.5rem] font-monts text-[#B49A18] "
>
  ...
  <div class="flex h-fit w-full items-center justify-center gap-[0.5em]">
    ...
    <p class="text-[0.75rem] font-bold">{progress}/2500</p>
    </div>
    <div
  ...
  >
    ...
    <p
      class="absolute left-1/2 top-1/2 h-fit w-full -translate-y-1/2 translate-x-1/2 px-[2rem] text-left text-[1rem] font-bold duration-300 group-hover:-translate-x-1/2 text-right"
    >
